...
public:
    ...
    MTL::RenderPipelineState* Compile(class MetalBinaryArchive& binaryArchive, bool forceCompile, bool isRenderThread, bool showInOverlay, bool& attemptedCompilation);
