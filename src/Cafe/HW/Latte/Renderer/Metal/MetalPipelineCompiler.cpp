...
MTL::RenderPipelineState* MetalPipelineCompiler::Compile(class MetalBinaryArchive& binaryArchive, bool forceCompile, bool isRenderThread, bool showInOverlay, bool& attemptedCompilation)
{
    if (forceCompile)
	{
    ...
    if (m_usesGeometryShader)
    {
        ...
        // Binary archive
        //binaryArchive.LoadPipeline(desc);
        ...
        // Serialize
        //if (pipeline)
        //    binaryArchive.SavePipeline(desc);
    }
    else
    {
